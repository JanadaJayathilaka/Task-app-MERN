              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className={TIP_CARD.text}>
                    Check my portfolio using below link
                  </p>
                  <a
                    href="https://react-personal-portfolio-nu-indol.vercel.app/"
                    target="_blank"
                    className=" block  hover:underlinemt-2 text-sm text-purple-500 "
                  >
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-40">
          ...
          <div
            ...
            onClick={(e) => e.stopPropagation()} //parent elements doesn't triggered
          >
